@php
    $primaryInstitutionName = old('institution_name', $program->firstBatch?->institution?->name ?? '');
    $themePresets = [
    ...
    <div class="row g-4">
        <div class="col-lg-7">
            <div class="row g-3">
                ...
                <div class="col-md-6"><label class="form-label" for="institution_name">Nama sekolah/lembaga</label><input class="form-control @error('institution_name') is-invalid @enderror" id="institution_name" name="institution_name" value="{{ $primaryInstitutionName }}" placeholder="SMP IT Mentari Ilmu Jatisari">@error('institution_name')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
