...
class UpdateStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'employee_number' => ['nullable', 'string', 'max:50', Rule::unique('teacher_profiles')->ignore($staff?->teacherProfile)],
    ...
    public function after(): array
    {
        return [function (Validator $validator): void {
            if ($this->input('role') === RoleSlug::Admin->value && ! $this->user()?->hasRole(RoleSlug::SuperAdmin)) {
                $validator->errors()->add('role', 'Hanya super-admin yang dapat mengelola admin sekolah.');
            }
